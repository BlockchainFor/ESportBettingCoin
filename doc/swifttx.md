...
This mechanism has been integrated into Bitcore-Node-ESportBettingCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ESportBettingCoin-Project/insight-api-esportbettingcoin#web-socket-api](https://github.com/ESportBettingCoin-Project/insight-api-esportbettingcoin#web-socket-api) 
* API: [https://github.com/ESportBettingCoin-Project/insight-api-esportbettingcoin#swifttx-transactions](https://github.com/ESportBettingCoin-Project/insight-api-esportbettingcoin#swifttx-transactions) 
...
By default, the ESportBettingCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ESportBettingCoin Core daemon:
