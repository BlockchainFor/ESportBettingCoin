...
In order to support loading of multiple wallets in esportbettingcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is esportbettingcoin.cpp.
...
Changes to esportbettingcoin.cpp
----------------------
esportbettingcoin.cpp is the entry point into esportbettingcoin-qt, and as such, will require some minor modifications to provide hooks for
