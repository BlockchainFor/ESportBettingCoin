...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Esportbettingcoin Core esportbettingcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  esportbettingcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded esportbettingcoin transaction") + "\n" +
                               "  esportbettingcoin-tx [options] -create [commands]   " + _("Create hex-encoded esportbettingcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded esportbettingcoin transaction
