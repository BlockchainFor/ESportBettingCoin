...
#if defined(NDEBUG)
#error "e-Sport Betting Coin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight <= 41000 && nHeight >= 26001) {
        nSubsidy = 5.5 * COIN;
    }
	else if (nHeight <= 69800 && nHeight >= 41001) {
        nSubsidy = 6.5 * COIN;
    }
	else if (nHeight <= 134600 && nHeight >= 69801) {
        nSubsidy = 8.5 * COIN;
    }
	else if (nHeight <= 525600 && nHeight >= 134601) {
        nSubsidy = 11 * COIN;
    }
    else {
        nSubsidy = 0 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	else if (nHeight <= 41000 && nHeight >= 26601) {
       ret = 5 * COIN;
    }
	else if (nHeight <= 69800 && nHeight >= 41001) {
       ret = 6 * COIN;
...
{
    RenameThread("esportbettingcoin-scriptch");
