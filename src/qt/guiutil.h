...
/** Utility functions used by the e-Sport Betting Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render e-Sport Betting Coin addresses in monospace font
...
// Parse "esportbettingcoin:" URI into recipient object, return true on successful parsing
