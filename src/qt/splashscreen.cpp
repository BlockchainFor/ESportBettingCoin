...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("e-Sport Betting Coin Core");
	...
	QString copyrightTextESBC = QChar(0xA9) + QString(tr(" 2018 The e-Sport Betting Coin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextESBC);
