...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("e-Sport Betting Coin Core"),
     ...
     * override -datadir in the esportbettingcoin.conf file in the default data directory
     * (to be consistent with esportbettingcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
