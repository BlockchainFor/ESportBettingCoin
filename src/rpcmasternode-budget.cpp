...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a e-Sport Betting Coin initiative\n"
            "  vote-alias         - Vote on a e-Sport Betting Coin initiative\n"
            "  vote               - Vote on a e-Sport Betting Coin initiative/budget\n"
...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"esportbettingcoin-address\" monthy-payment\n"
            ...
            "5. \"esportbettingcoin-address\":   (string, required) e-Sport Betting Coin address to send payments to\n"
            "6. monthly-payment:  (numeric, required) Monthly payment amount\n"

            "\nResult:\n"
            "\"xxxx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://\" 2 820800 \"\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://\" 2 820800 \"\" 500"));
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"esportbettingcoin-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://\" 2 820800 \"\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://\" 2 820800 \"\" 500"));
...
Value getbudgetprojection(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) e-Sport Betting Coin address of payment\n"
