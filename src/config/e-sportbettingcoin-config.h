/* src/config/esportbettingcoin-config.h.  Generated from esportbettingcoin-config.h.in by configure.  */
/* src/config/esportbettingcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ESBC_CONFIG_H

#define ESBC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.esportbettingcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Esportbettingcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Esportbettingcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "esportbettingcoin"
