...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop e-Sport Betting Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "e-Sport Betting Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* e-Sport Betting Coin features */
        {"esportbettingcoin", "masternode", &masternode, true, true, false},
        {"esportbettingcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"esportbettingcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"esportbettingcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"esportbettingcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"esportbettingcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"esportbettingcoin", "startmasternode", &startmasternode, true, true, false},
        {"esportbettingcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"esportbettingcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"esportbettingcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"esportbettingcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"esportbettingcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"esportbettingcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"esportbettingcoin", "mnbudget", &mnbudget, true, true, false},
        {"esportbettingcoin", "preparebudget", &preparebudget, true, true, false},
        {"esportbettingcoin", "submitbudget", &submitbudget, true, true, false},
        {"esportbettingcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"esportbettingcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"esportbettingcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"esportbettingcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"esportbettingcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"esportbettingcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"esportbettingcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"esportbettingcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"esportbettingcoin", "mnsync", &mnsync, true, true, false},
        {"esportbettingcoin", "spork", &spork, true, true, false},
        {"esportbettingcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"esportbettingcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use esportbettingcoind, or the -server option to esportbettingcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> esportbettingcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38816/\n";
}
